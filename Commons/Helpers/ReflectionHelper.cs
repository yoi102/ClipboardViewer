...
public static class ReflectionHelper
{
    ...
    private static bool TryLoadAssembly(string asmPath, [MaybeNullWhen(false)] out Assembly assembly)
    {
        AssemblyName asmName = AssemblyName.GetAssemblyName(asmPath);
        assembly = null;
        try
    ...
    private static bool TryLoadAssembly(AssemblyName assemblyName, [MaybeNullWhen(false)] out Assembly assembly)
    {
        assembly = null;
        try
        {
